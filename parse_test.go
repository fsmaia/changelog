...
var (
	versions = []testRegexpOutput{
		...
		{
			text:    " ## v1.2.3.4.5 (2015-02-30)",
			matched: []string{"## v1.2.3.4.5 (2015-02-30)", "v1.2.3.4.5", "2015-02-30"},
		},
		{
			text:    " ## v1.2.3.4.5-alpha (2015-02-30)",
			matched: []string{"## v1.2.3.4.5-alpha (2015-02-30)", "v1.2.3.4.5-alpha", "2015-02-30"},
		},
	}
